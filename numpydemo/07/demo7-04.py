...
sample_rate, noised_sigs = wf.read('C:\\Users\\Administrator\\Desktop\\sucai\\da_data\\noised.wav')
...
mp.tick_params(labelsize=8)
mp.grid(linestyle=":")
mp.plot(freqs[freqs>0], noised_pows[freqs>0], c='orangered', label='Noised')
mp.legend()
...
# 重新生成音频文件
wf.write('C:\\Users\\Administrator\\Desktop\\sucai\\da_data\\filter.wav', sample_rate, filter_sigs.astype(np.int16))
